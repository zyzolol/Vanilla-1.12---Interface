	...
	portraitDebuff.duration = portraitDurationFrame:CreateFontString(nil, 'OVERLAY')--, 'GameFontNormalLarge')
	portraitDebuff.duration:SetFont(STANDARD_TEXT_FONT, 28, 'OUTLINE')
	...
	portraitDebuff.duration:SetPoint('CENTER', TargetPortrait, 'CENTER', -1, 0)
	-- cooldown spiral
